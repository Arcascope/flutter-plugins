...
class HealthFactory {
  ...
  static Future<bool> useHealthConnect() async {
    return await _channel.invokeMethod('useHealthConnect');
  }

  static Future<bool> useGoogleFit() async {
    return await _channel.invokeMethod('useGoogleFit');
  }
